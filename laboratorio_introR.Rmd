---
title: 'Laboratorio: Introducción a R y Tratamiento de Datos'
author: "Víctor Aceña"
date: "Inferencia Estadística"
output: 
...
```{r}
download.file(url = "https://github.com/URJCDSLab/LaboratoriosRInferenciaEstadistica/tree/main/data/lab.xlsx",
              destfile = "datos/lab.xlsx", mode = "wb")
```
...
```{r}
download.file(url = "https://github.com/URJCDSLab/LaboratoriosRInferenciaEstadistica/tree/main/data/ejDatos.csv",
